...
-   **Everything related to this presentation**
    ...
    -   [Shiny code](https://github.com/deepshamenghani/chatbot_shiny_python)
-   **Supporting blogs**
    -   [Superhero facts RAG Q&A bot](https://medium.com/data-science-at-microsoft/how-i-built-a-superhero-facts-rag-qa-bot-using-langchain-qdrant-and-openai-20a04202c6b1?sk=01babb6394b331bd07ac26b2de9cf5b5)
    -   [Incorporate a chatbot to Shiny for Python](https://medium.com/towards-data-science/incorporate-an-llm-chatbot-into-your-web-application-with-openai-python-and-shiny-fe78673a5d26?sk=06086c4c352edbcad0137a35dfef52fa)
